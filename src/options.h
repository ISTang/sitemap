...
#ifndef SITEMAP_CONFIG
#define SITEMAP_CONFIG

#include "config.h"

/* This files allows a lot of customizations of sitemap
...
// if you enable this option, update forbiddenExtensions in sitemap.conf
#define IMAGES
...
// be carefull, sitemap might use 10 to 20% more
